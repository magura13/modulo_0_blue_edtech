// Jogo Jokenpô: Utilizando os conceitos aprendidos até estruturas de repetição, crie um programa que jogue pedra, papel e tesoura (Jokenpô).
...
do {
    ...
    for (let cont = 0; cont < choice; cont++) {
        ...
        let mychoice = +prompt(`Qual a sua escolha:`); //ESCOLHA DO PLAYER
